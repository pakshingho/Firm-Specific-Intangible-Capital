%----------------------------------------------------------------
% CES version with both l1 l2 z1, without z2
%----------------------------------------------------------------
...
// Technology 2
lambda2 theta2 alpha2 gamma2 deltaI
...
stoch_simul(irf = 25, order = 1) y1 x y2 k1 k2 kT kT1 kT2 kI kI1 kI2 l1 l2 z1 q;