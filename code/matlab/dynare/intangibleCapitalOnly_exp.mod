...
model;
    ...
    exp(k1) = ( theta1 * 0 ^ ((lambda1 - 1) / lambda1) + (1 - theta1) * exp(kI1) ^ ((lambda1 - 1) / lambda1) ) ^ (lambda1 / (lambda1 - 1));
...
initval;
    ...
    k1  = log( ( theta1 * 0 ^ ((lambda1 - 1) / lambda1) + (1 - theta1) * exp(kI1) ^ ((lambda1 - 1) / lambda1) ) ^ (lambda1 / (lambda1 - 1)) );
