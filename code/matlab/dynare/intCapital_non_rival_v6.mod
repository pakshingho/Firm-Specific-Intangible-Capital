...
model;
    ...
    k1 = ( theta1 * ( sk * k(-1) ) ^ ((lambda1 - 1) / lambda1) + (1 - theta1) * ( h(-1) ) ^ ((lambda1 - 1) / lambda1) ) ^ (lambda1 / (lambda1 - 1));
    
    // 2. Production function 2
    y2     = k2 ^ alpha2 * (exp(z2) * n2) ^ gamma2;
    k2 = ( theta2 * ( (1 - sk ) * k(-1) ) ^ ((lambda2 - 1) / lambda2) + (1 - theta2) * ( h(-1) ) ^ ((lambda2 - 1) / lambda2) ) ^ (lambda2 / (lambda2 - 1));
    ...
    alpha1 * (1 - theta1) * y1(+1) / k1(+1) * ( k1(+1) / ( h ) ) ^ (1 / lambda1)
    + q(+1) * ( ( 1 - deltaH ) + alpha2 * (1 - theta2) * y2(+1) / k2(+1) * ( k2(+1) / ( h ) ) ^ (1 / lambda2) )
    = (1 + ri) * q;
...
initval;
    ...
    k1  = ( theta1 * ( sk * k ) ^ ((lambda1 - 1) / lambda1) + (1 - theta1) * ( h ) ^ ((lambda1 - 1) / lambda1) ) ^ (lambda1 / (lambda1 - 1));
    y1  = k1 ^ alpha1 * (exp(z1) * n1) ^ gamma1;
    k2 = ( theta2 * ( (1 - sk ) * k ) ^ ((lambda2 - 1) / lambda2) + (1 - theta2) * ( h ) ^ ((lambda2 - 1) / lambda2) ) ^ (lambda2 / (lambda2 - 1));
    q  = 0.757152;
    //b  =  -0.05;
end;
