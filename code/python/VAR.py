...
#dataHP = dataHP[(dataHP.index >= '1955-01-01') & (dataHP.index <= '2020-01-31')]
modelHP = VAR(dataHP)
resultHP = modelHP.fit(maxlags=4, ic=None, verbose=True)
resultHP.summary()
...
# customized irfs 'logDiffOutput', 'logDiffI_int', 'logDiffI_tan'
...
# 'logDiffOutput', 'logDiffI_int', 'logDiffI_tan'
pd.Series(irfHP.cum_effects[0:21,0,0]).plot()
pd.Series(irfHP.cum_effects[0:21,1,0]).plot()
pd.Series(irfHP.cum_effects[0:21,2,0]).plot()


# 'logDiffI_tan', 'logDiffI_int', 'logDiffOutput'
pd.Series(irfHP.cum_effects[0:21,0,2]).plot()
pd.Series(irfHP.cum_effects[0:21,1,2]).plot()
pd.Series(irfHP.cum_effects[0:21,2,2]).plot()

# plots
band=irfHP.errband_mc(repl=1000, orth=False, signif=0.05)
bandcum=irfHP.cum_errband_mc(repl=1000, orth=False, signif=0.05)
...
plt.subplot(3,1,1)
plt.title('Impulse responses to output shock')
plt.plot(pd.Series(irfHP.irfs[0:15,2,2]))
plt.plot(pd.Series(band[0][0:15,2,2]), 'k--')
plt.plot(pd.Series(band[1][0:15,2,2]), 'k--')
plt.ylabel('Output')

plt.subplot(3,1,2)
plt.plot(pd.Series(irfHP.irfs[0:15,1,2]))
plt.plot(pd.Series(band[0][0:15,1,2]), 'k--')
plt.plot(pd.Series(band[1][0:15,1,2]), 'k--')
plt.ylabel('Intangible\nInvestment')

plt.subplot(3,1,3)
plt.plot(pd.Series(irfHP.irfs[0:15,0,2]))
plt.plot(pd.Series(band[0][0:15,0,2]), 'k--')
plt.plot(pd.Series(band[1][0:15,0,2]), 'k--')
plt.ylabel('Tangible\nInvestment')
plt.show()
...
#plt.suptitle('Cumulative responses to output shock')

plt.subplot(3,1,1)
plt.title('Cumulative responses to output shock')
plt.plot(pd.Series(irfHP.cum_effects[0:15,2,2]))
plt.plot(pd.Series(bandcum[0][0:15,2,2]), 'k--')
plt.plot(pd.Series(bandcum[1][0:15,2,2]), 'k--')
plt.ylabel('Output')

plt.subplot(3,1,2)
plt.plot(pd.Series(irfHP.cum_effects[0:15,1,2]))
plt.plot(pd.Series(bandcum[0][0:15,1,2]), 'k--')
plt.plot(pd.Series(bandcum[1][0:15,1,2]), 'k--')
#plt.ylim(-2,10)
plt.yticks(np.arange(-1, pd.Series(bandcum[1][0:21,1,2]).max(), 3))
plt.ylabel('Intangible\nInvestment')

plt.subplot(3,1,3)
plt.plot(pd.Series(irfHP.cum_effects[0:15,0,2]))
plt.plot(pd.Series(bandcum[0][0:15,0,2]), 'k--')
plt.plot(pd.Series(bandcum[1][0:15,0,2]), 'k--')
plt.ylabel('Tangible\nInvestment')

plt.show()


# cirf alternative plot
fig, axs = plt.subplots(3,1, sharex=True, figsize= (8,6))
#fig.subplots_adjust(hspace=0)
fig.suptitle('Cumulative responses', fontsize=16)

axs[0].plot(pd.Series(irfHP.cum_effects[0:21,0,2]))
axs[0].plot(pd.Series(bandcum[0][0:21,0,2]), 'k--')
axs[0].plot(pd.Series(bandcum[1][0:21,0,2]), 'k--')
axs[0].set_title('Output -> Tangible Investment')

axs[1].plot(pd.Series(irfHP.cum_effects[0:21,1,2]))
axs[1].plot(pd.Series(bandcum[0][0:21,1,2]), 'k--')
axs[1].plot(pd.Series(bandcum[1][0:21,1,2]), 'k--')
axs[1].set_title('Output -> Intangible Investment')
axs[1].set_yticks(np.arange(-1, pd.Series(bandcum[1][0:21,1,2]).max(), 3))
#axs[1].set_ylim(-2,pd.Series(bandcum[1][0:21,1,2]).max())

axs[2].plot(pd.Series(irfHP.cum_effects[0:21,2,2]))
axs[2].plot(pd.Series(bandcum[0][0:21,2,2]), 'k--')
axs[2].plot(pd.Series(bandcum[1][0:21,2,2]), 'k--')
axs[2].set_title('Output -> Output')

plt.show()

# irf first column, cirf second column
plt.figure(3, figsize= (10,10))
plt.subplot(3,2,1)
plt.plot(pd.Series(irfHP.irfs[0:21,0,2]))
plt.plot(pd.Series(band[0][0:21,0,2]), 'k--')
plt.plot(pd.Series(band[1][0:21,0,2]), 'k--')
plt.subplot(3,2,3)
plt.plot(pd.Series(irfHP.irfs[0:21,1,2]))
plt.plot(pd.Series(band[0][0:21,1,2]), 'k--')
plt.plot(pd.Series(band[1][0:21,1,2]), 'k--')
plt.subplot(3,2,5)
plt.plot(pd.Series(irfHP.irfs[0:21,2,2]))
plt.plot(pd.Series(band[0][0:21,2,2]), 'k--')
plt.plot(pd.Series(band[1][0:21,2,2]), 'k--')
plt.subplot(3,2,2)
plt.plot(pd.Series(irfHP.cum_effects[0:21,0,2]))
plt.plot(pd.Series(bandcum[0][0:21,0,2]), 'k--')
plt.plot(pd.Series(bandcum[1][0:21,0,2]), 'k--')
plt.subplot(3,2,4)
plt.plot(pd.Series(irfHP.cum_effects[0:21,1,2]))
plt.plot(pd.Series(bandcum[0][0:21,1,2]), 'k--')
plt.plot(pd.Series(bandcum[1][0:21,1,2]), 'k--')
plt.subplot(3,2,6)
plt.plot(pd.Series(irfHP.cum_effects[0:21,2,2]))
plt.plot(pd.Series(bandcum[0][0:21,2,2]), 'k--')
plt.plot(pd.Series(bandcum[1][0:21,2,2]), 'k--')
plt.show()

# output to output
band=irfHP.errband_mc(repl=1000, orth=False)
pd.Series(band[0][0:21,0,0]).plot()
pd.Series(band[1][0:21,0,0]).plot()
pd.Series(irfHP.irfs[0:21,0,0]).plot()
...
# IRF & CIRF high low plots
fig, axs = plt.subplots(2,1, sharex=False, figsize= (8,6))
#fig.subplots_adjust(hspace=0)
fig.suptitle('Responses', fontsize=16)

axs[0].plot(irfHP_H.irfs[0:10,2,2])
axs[0].plot(irfHP_L.irfs[0:10,2,2])
axs[0].set(ylabel='Impulse')
axs[0].legend(['Post-periods',
            'Pre-period'])

axs[1].plot(irfHP_H.cum_effects[0:15,2,2])
axs[1].plot(irfHP_L.cum_effects[0:15,2,2])
axs[1].set(ylabel='Cumulative')
